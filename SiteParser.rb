...
module SiteParser
  def melon(url)
    ...
    detail[:author] = detail_table[2].at('.//td//a').text
    detail[:genre] = detail_table[3].at('.//td//a').text
  ...
  def lashin(url)
    ...
    detail[:author] = detail_area[1].at('.//dd//a').text
    detail[:genre] = detail_area[2].at('.//dd//a').text
